...
pone la longitud de la palabra, como la longitud del vector. Después ingresa la palabra en el vector, letra
por letra, quedando cada letra de la palabra en un índice del vector. Y también, guarda la cantidad de jugadas 
 ...
 */
package guia.pkg9.ejercicio.extra.pkg2;
...
public class Guia9EjercicioExtra2 {
    ...
    public static void main(String[] args) {
        AhorcadoService objeto = new AhorcadoService();
      objeto.Juego();
    }
