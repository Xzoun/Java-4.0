...
carga de agua,se dispara y se moja. Las clases por hacer del juego son las siguientes:
...
(la posición del tambor donde se encuentra el agua). Estas dos posiciones, se
...
package com.mycompany.guia11.ejercicio2;
...
public class Guia11Ejercicio2 {
    ...
    public static void main(String[] args) {
        ...
        iniciar.llenarJuego(jugadoresList, r1);
