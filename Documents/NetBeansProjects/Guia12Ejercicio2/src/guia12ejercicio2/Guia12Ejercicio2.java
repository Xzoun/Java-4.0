...
color,consumo energético (letras entre A y F) y peso.
...
está en mayúsculas o en minúsculas. Este método se invocará al crear el objeto y
no será visible.
...
import Guia12Ejercicio3.Menu;

public class Guia12Ejercicio2 {

    public static void main(String[] args) {
        Menu nuevaMuestra = new Menu();
        nuevaMuestra.menu();
    }
}
